...
def add(tableName):
    ...
    if tableName == 'tbl_publisher':
        ...
        nameInput = input(
            "What would you like to name the publisher(type 'quit' to quit)?:\n")
        if nameInput == 'quit':
            return
        print("\nPlease limit input to 45 characters.")
        addrInput = input(
            "What is the address of the publisher(type 'quit' to quit)?:\n")
        if addrInput == 'quit':
            return
        print("\nPlease limit input to valid phone number.")
        phoneInput = input(
            "What is the phone number of the publisher(type 'quit' to quit)?:\n")
        if phoneInput == 'quit':
            return
        ...
        print("\nPlease limit input to 45 characters.")
        nameInput = input(
            "What would you like to name the library branch(type 'quit' to quit)?:\n")
        if nameInput == 'quit':
            return
        print("\nPlease limit input to 45 characters.")
        addrInput = input(
            "What is the address of the library branch(type 'quit' to quit)?:\n")
        if addrInput == 'quit':
            return
        ...
        print("\nPlease limit input to 45 characters.")
        nameInput = input(
            "What would you like to name the borrower(type 'quit' to quit)?:\n")
        if nameInput == 'quit':
            return
        print("\nPlease limit input to 45 characters.")
        addrInput = input(
            "What is the address of the borrower(type 'quit' to quit)?:\n")
        if addrInput == 'quit':
            return
        print("\nPlease limit input to valid phone number.")
        phoneInput = input(
            "What is the phone number of the borrower(type 'quit' to quit)?:\n")
        if phoneInput == 'quit':
            return
...
def addBookAuthor():
    ...
    if check.validInput(choice, 1, 3):
        ...
        if choice != 3:
            ...
            # tileInp going into
            titleInp = input(
                "Please enter the title of the new book (type 'quit' to cancel):\n")
            # If user types quit
            ...
            if check.validInput(pubInp, 1, numPubs+1):
                ...
                # If choice = 2
                    ...
                    nameInp = input(
                        "Please enter the name of the new author (type 'quit' to cancel):\n")
                    # If user types quit
        ...
        if check.validInput(inp, 1, numBors + 1):
            ...
            if inp != numBors + 1:
                ...
                try:
                    cursor = connection.cursor()
                    cursor.execute(
                        "SELECT * FROM tbl_book_loans WHERE cardNo = %s", (cardNum,))
                ...
                # Otherwise, show the user their loans
                    ...
                    while loanInp != loanCount + 1:
                        ...
                        for i in range(0, loanCount):
                            ...
                            print(
                                f"{i+1}) Branch: {borLoanNames[i][1]}, Book: {borLoanNames[i][2]}, Date Out: {dateOut}, Due Date: {dueDate}")
                        ...
                        if check.validInput(loanInp, 1, loanCount + 1):
                            ...
                            if loanInp != loanCount + 1:
                                ...
                                newDate = input(
                                    "Please input new date (yyyy-mm-dd), enter 'quit' if no change:\n")
